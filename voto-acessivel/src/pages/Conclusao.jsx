  ...
  return (
    ...
    >   
      ...
      <div className="logo-container" aria-label="Logo Voto Acessível">
        ...
        <h1 className="loading-title">Voto Concluído!</h1>
        <h2 className="loading_subtitle">Dirija-se à mesa para inserir o seu voto na urna</h2>
      </div>

      <button className="click-text">Clique para começar uma nova votação</button>
    </div>
  );
}
